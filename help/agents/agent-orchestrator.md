...
| --- | --- | --- |
| [Adobe Marketing Agent para [!DNL Microsoft 365 Copilot]](ama-ms.md) | Recupere instantaneamente insights de marketing do Adobe Experience Platform em aplicativos [!DNL Microsoft 365] como [!DNL Teams], [!DNL Word], [!DNL Powerpoint] e [!DNL Excel]. Com esse agente, você pode manter um histórico de bate-papo em todos os aplicativos e continuar sua conversa enquanto trabalha. | |
